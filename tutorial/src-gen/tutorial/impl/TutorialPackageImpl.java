...
public class TutorialPackageImpl extends EPackageImpl implements TutorialPackage {
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation(colorEClass, source, new String[] { "rgbValues",
				"\n\t\t\tred >= 0 and red <= 255 \n\t\t\tand green >= 0 and green <= 255\n\t\t\tand blue >= 0 and blue <= 255\n\t\t" });
		addAnnotation(componentEClass, source, new String[] { "itemTypeBasic", "itemType.oclIsTypeOf(BasicItemType)" });
		addAnnotation(itemConnectionEClass, source, new String[] { "markerOnItemtype",
