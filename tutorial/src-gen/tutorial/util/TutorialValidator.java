...
public class TutorialValidator extends EObjectValidator {
	...
	/**
	 * The cached validation expression for the rgbValues constraint of '<em>Color</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String COLOR__RGB_VALUES__EEXPRESSION = "\n" + "\t\t\tred >= 0 and red <= 255 \n"
	...
	public boolean validateColor_rgbValues(Color color, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(TutorialPackage.Literals.COLOR, color, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "rgbValues", COLOR__RGB_VALUES__EEXPRESSION,
	...
	/**
	 * The cached validation expression for the itemTypeBasic constraint of '<em>Component</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String COMPONENT__ITEM_TYPE_BASIC__EEXPRESSION = "itemType.oclIsTypeOf(BasicItemType)";
	...
	public boolean validateComponent_itemTypeBasic(Component component, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		return validate(TutorialPackage.Literals.COMPONENT, component, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "itemTypeBasic",
				COMPONENT__ITEM_TYPE_BASIC__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
	}
	...
	/**
	 * The cached validation expression for the markerOnItemtype constraint of '<em>Item Connection</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String ITEM_CONNECTION__MARKER_ON_ITEMTYPE__EEXPRESSION = "\n"
	...
	public boolean validateItemConnection_markerOnItemtype(ItemConnection itemConnection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		return validate(TutorialPackage.Literals.ITEM_CONNECTION, itemConnection, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "markerOnItemtype",
				ITEM_CONNECTION__MARKER_ON_ITEMTYPE__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
	}
